      ...
      <div className="Home-container">
        <div className="Home">
          <div className="home-content">
            ...
            <p>
              Plan ,Organize and execute tasks effortlessly with ur nttuitive
              todos set prioties,track progess and meet deadlines seamlessly
            </p>
        ...
        <div className="Home-create-Task">
          <div className="Home-create-Task-content1">
            ...
            <p>
              Add tasks with just a few clicks,assign deadlines, set priorities
        ...
        <div className="Home-create-Task">
          ...
          <div className="Home-create-Task-content">
            ...
            <p>
              Quickly review task details, deadlines, and priorities in one
              oraganized view
            </p>
          </div>
        </div>
        ...
        <div className="Home-create-Task">
          ...
          <div className="Home-create-Task-content">
            ...
            <p>
              Easily remove Task you no longer need, keeping your workspace
              clutter-free.
            </p>
          </div>
        </div>
        ...
        <div className="Home-create-Task">
          <div className="Home-create-Task-content1">
            ...
            <p>
              Keep your most important tasks front and center by pinning them to
              the top.
            </p>
          </div>
          <div className="Home-create-Task-img2">
